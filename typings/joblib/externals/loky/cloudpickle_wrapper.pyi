...
class CloudpickledObjectWrapper:
    ...
    def __reduce__(self): # -> tuple[(__data: bytes, *, fix_imports: bool = ..., encoding: str = ..., errors: str = ..., buffers: Iterable[Any] | None = ...) -> Any, tuple[bytes]] | tuple[(_pickled_object: Unknown, keep_wrapper: Unknown) -> (CallableObjectWrapper | CloudpickledObjectWrapper), tuple[bytes, Unknown]]:
        ...
