...
def get_decoders():  # -> list[tuple[Pattern[str], (line: Unknown, match: Unknown) -> dict[str, dict[str, str | Unknown] | dict[str, int] | dict[str, List[text_type]] | dict[str, Unknown]]]]:
...
def decode_windowsnt(line, match):  # -> dict[str, dict[str, Unknown] | dict[str, int]]:
