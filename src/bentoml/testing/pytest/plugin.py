...
def _setup_test_directory() -> tuple[str, str]:
    # NOTE: lazy load this funcall to avoid circular import with psutil inside bazel,
    # as we only use this function when pytest starts (which is after analyze phase).
    # TODO: This has to do with bazel modifying PYTHONPATH and imports from prebuilt
    # psutil creates circular imports during analysis phase.
    from ..._internal.utils import validate_or_create_dir
