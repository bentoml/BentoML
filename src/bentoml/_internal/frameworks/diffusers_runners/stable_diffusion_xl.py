...
MODEL_SHORT_NAME = "sdxl"
DEFAULT_MODEL_ID = "stabilityai/stable-diffusion-xl-base-1.0"
PIPELINE_MAPPING = {
    "text2img": diffusers.StableDiffusionXLPipeline,
    "img2img": diffusers.StableDiffusionXLImg2ImgPipeline
}
...
def create_runner(
        ...
        *,
        ...
        pipeline_class: str | type[diffusers.DiffusionPipeline] = diffusers.StableDiffusionXLPipeline,
    ...
    model = get_model_or_download(
        MODEL_SHORT_NAME, model_id, use_available=use_available, pipeline_class=pipeline_class,
    )
