...
| [triton_runner](https://github.com/bentoml/BentoML/tree/main/examples/triton_runner)                                                         | PyTorch, Tensorflow, ONNX | YOLOv5, MNIST Classifier             | Triton Inference Server, gRPC, Python SDK (Containerization, Serve, Build) |
