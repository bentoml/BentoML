...
FROM bento-server:base-python$PYTHON_VERSION-ubi8 as build_image
...
COPY generated/bento-server/ubi8/cudnn/cuda.repo /etc/yum.repos.d/cuda.repo
COPY generated/bento-server/ubi8/cudnn/nvidia-ml.repo /etc/yum.repos.d/nvidia-ml.repo
