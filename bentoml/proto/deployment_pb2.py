...
_LISTDEPLOYMENTSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operators', full_name='bentoml.ListDeploymentsRequest.operators', index=3,
...
_LISTDEPLOYMENTSREQUEST.fields_by_name['operators'].enum_type = _DEPLOYMENTSPEC_DEPLOYMENTOPERATOR
