...
class DeploymentSpec(google.protobuf.message.Message):
    ...
    @property
    def custom_operator_config(
        self,
    ) -> global___DeploymentSpec.CustomOperatorConfig: ...
    @property
    def sagemaker_operator_config(
        self,
    ) -> global___DeploymentSpec.SageMakerOperatorConfig: ...
    @property
    def aws_lambda_operator_config(
        self,
    ) -> global___DeploymentSpec.AwsLambdaOperatorConfig: ...
    @property
    def azure_functions_operator_config(
        self,
    ) -> global___DeploymentSpec.AzureFunctionsOperatorConfig: ...
    @property
    def aws_ec2_operator_config(
        self,
    ) -> global___DeploymentSpec.AwsEc2OperatorConfig: ...
    def __init__(
        self,
        *,
        bento_name: typing.Text = ...,
        bento_version: typing.Text = ...,
        operator: global___DeploymentSpec.DeploymentOperator.V = ...,
        custom_operator_config: typing.Optional[
            global___DeploymentSpec.CustomOperatorConfig
        ] = ...,
        sagemaker_operator_config: typing.Optional[
            global___DeploymentSpec.SageMakerOperatorConfig
        ] = ...,
        aws_lambda_operator_config: typing.Optional[
            global___DeploymentSpec.AwsLambdaOperatorConfig
        ] = ...,
        azure_functions_operator_config: typing.Optional[
            global___DeploymentSpec.AzureFunctionsOperatorConfig
        ] = ...,
        aws_ec2_operator_config: typing.Optional[
            global___DeploymentSpec.AwsEc2OperatorConfig
        ] = ...,
    ) -> None: ...
    def HasField(
...
class Deployment(google.protobuf.message.Message):
    ...
    class AnnotationsEntry(google.protobuf.message.Message):
        ...
        value: typing.Text = ...
        def __init__(
            self, *, key: typing.Text = ..., value: typing.Text = ...,
        ) -> None: ...
        def ClearField(
            self,
...
class GetDeploymentRequest(google.protobuf.message.Message):
    ...
    namespace: typing.Text = ...
    def __init__(
        self, *, deployment_name: typing.Text = ..., namespace: typing.Text = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
