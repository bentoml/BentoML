...
def start_yatai_service_grpc_server(
    ...
    click.echo(
        ...
        f'*  bentoml.yatai.client.get_yatai_client("127.0.0.1:{grpc_port}").repository.list()\n'
        f'* Usage in CLI:\n'
        f'*  bentoml list --yatai-url=127.0.0.1:{grpc_port}\n'
        f'*  bentoml containerize IrisClassifier:latest --yatai-url=127.0.0.1:{grpc_port}\n'
        f'*  bentoml push IrisClassifier:20200918001645_CD2886 --yatai-url=127.0.0.1:{grpc_port}\n'
        f'*  bentoml pull IrisClassifier:20200918001645_CD2886 --yatai-url=127.0.0.1:{grpc_port}\n'
        f'*  bentoml retrieve IrisClassifier:20200918001645_CD2886 --yatai-url=127.0.0.1:{grpc_port} --target_dir="/tmp/foo/bar"\n'
        f'*  bentoml delete IrisClassifier:20200918001645_CD2886 --yatai-url=127.0.0.1:{grpc_port}\n'
