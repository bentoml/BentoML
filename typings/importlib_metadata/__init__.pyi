...
class MetadataPathFinder(NullFinder, DistributionFinder):
    def find_distributions(self, context=...) -> Mapping[str, PathDistribution]: ...
    def invalidate_caches(cls: "MetadataPathFinder") -> None: ...
...
def distributions(**kwargs: Any) -> Iterator[Any]: ...
def metadata(distribution_name: str) -> _meta.PackageMetadata: ...
def version(distribution_name: str) -> str: ...
def entry_points(
    **params: Mapping[str, Any]
) -> Union[EntryPoints, SelectableGroups]: ...
def files(distribution_name: str) -> List[str]: ...
