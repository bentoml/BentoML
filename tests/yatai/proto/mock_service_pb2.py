...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x12mock_service.proto\"\x1c\n\x0bMockRequest\x12\r\n\x05input\x18\x01 \x01(\t\"\x1e\n\x0cMockResponse\x12\x0e\n\x06output\x18\x01 \x01(\t2\xdf\x01\n\x0bMockService\x12&\n\x07\x45xecute\x12\x0c.MockRequest\x1a\r.MockResponse\x12\x34\n\x13\x45xecuteClientStream\x12\x0c.MockRequest\x1a\r.MockResponse(\x01\x12\x34\n\x13\x45xecuteServerStream\x12\x0c.MockRequest\x1a\r.MockResponse0\x01\x12<\n\x19\x45xecuteClientServerStream\x12\x0c.MockRequest\x1a\r.MockResponse(\x01\x30\x01\x62\x06proto3'
)
...
_MOCKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='input', full_name='MockRequest.input', index=0,
...
_MOCKRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='output', full_name='MockResponse.output', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
MockRequest = _reflection.GeneratedProtocolMessageType('MockRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:MockRequest)
  })
...
MockResponse = _reflection.GeneratedProtocolMessageType('MockResponse', (_message.Message,), {
  ...
  '__module__' : 'mock_service_pb2'
  # @@protoc_insertion_point(class_scope:MockResponse)
  })
...
_MOCKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='MockService.ExecuteClientStream',
    index=1,
    containing_service=None,
    input_type=_MOCKREQUEST,
    output_type=_MOCKRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='MockService.ExecuteServerStream',
    index=2,
    containing_service=None,
    input_type=_MOCKREQUEST,
    output_type=_MOCKRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='MockService.ExecuteClientServerStream',
    index=3,
    containing_service=None,
    input_type=_MOCKREQUEST,
    output_type=_MOCKRESPONSE,
