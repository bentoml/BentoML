...
class Generator:
    ...
    @overload
    def standard_normal(
        self, *, out: ndarray[Any, dtype[float64]] = ...
    ...
    @overload
    def random(
        self, size: _ShapeLike = ..., *, out: Optional[ndarray[Any, dtype[float64]]] = ...
    ) -> ndarray[Any, dtype[float64]]: ...
    @overload
    def random(
        self,
    ...
    @overload
    def standard_gamma(
        self, shape: _ArrayLikeFloat_co, *, out: ndarray[Any, dtype[float64]] = ...
    ) -> ndarray[Any, dtype[float64]]: ...
    @overload
    def standard_gamma(
        self,
