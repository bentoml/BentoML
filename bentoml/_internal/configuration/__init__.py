...
try:
    ...
    class version_mod:
        version: str
        version_tuple: t.Tuple[t.Union[str, int], ...]
...
def is_pypi_installed_bentoml() -> bool:
    """
    Returns true if BentoML is installed via PyPI official release or installed from source with a release tag.
    ...
    * distance and not clean: {tag}.post{distance}+{scm letter}{revision hash}.dYYYYMMDD
    ...
    in_site_packages = bentoml_path and "site-packages" in bentoml_path
    ...
    return is_tagged and is_clean and not_been_modified and not in_site_packages
