...
class PandasArray(
    ...
    def any(
        self, *, axis: int | None = ..., out=..., keepdims: bool = ..., skipna: bool = ...
    ): ...
    def all(
        self, *, axis: int | None = ..., out=..., keepdims: bool = ..., skipna: bool = ...
    ): ...
    def min(self, *, axis: int | None = ..., skipna: bool = ..., **kwargs) -> Scalar: ...
    def max(self, *, axis: int | None = ..., skipna: bool = ..., **kwargs) -> Scalar: ...
    def sum(
