...
@overload
def safe_dump(data: Any, stream: Optional[BytesIO], *, default_style: Optional[str] = ..., default_flow_style: bool = ..., canonical: Optional[bool] = ..., indent: Optional[int] = ..., width: Optional[int] = ..., allow_unicode: Optional[bool] = ..., line_break: Optional[str] = ..., encoding: Optional[str] = ..., explicit_start: Optional[bool] = ..., explicit_end: Optional[bool] = ..., version: Optional[bool] = ..., tags: Optional[bool] = ..., sort_keys: bool = ...) -> None:
    ...

@overload
def safe_dump(data: Any, stream: None=..., *, default_style: Optional[str] = ..., default_flow_style: bool = ..., canonical: Optional[bool] = ..., indent: Optional[int] = ..., width: Optional[int] = ..., allow_unicode: Optional[bool] = ..., line_break: Optional[str] = ..., encoding: Optional[str] = ..., explicit_start: Optional[bool] = ..., explicit_end: Optional[bool] = ..., version: Optional[bool] = ..., tags: Optional[bool] = ..., sort_keys: bool = ...) -> BytesIO:
    ...
