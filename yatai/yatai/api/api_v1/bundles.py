...
def list_bundles(label_selectors: dict = None, skip: int = 0, limit: int = 20, order_by: str = None, ascending_order: bool = False):
    return []


@router.post('/', response_model=bundle_schema.AddBundleResponse) # or /{name}/version/{version}
def add_bundle():
    return {}
