...
class ObjectFactorizer(Factorizer):
    ...
    def factorize(
        self, values: np.ndarray, sort: bool = ..., na_sentinel=..., na_value=...
    ) -> np.ndarray: ...
...
class HashTable:
    ...
    def unique(
        self, values: np.ndarray, return_inverse: bool = ...
...
def duplicated_int64(
    values: np.ndarray, keep: Literal["last", "first", False] = ...
) -> np.ndarray: ...
def mode_int64(values: np.ndarray, dropna: bool) -> np.ndarray: ...
def value_count_int64(
    values: np.ndarray, dropna: bool
) -> tuple[np.ndarray, np.ndarray]: ...
def duplicated(
    values: np.ndarray, keep: Literal["last", "first", False] = ...
) -> np.ndarray: ...
