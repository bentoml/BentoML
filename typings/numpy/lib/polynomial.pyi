...
from typing import NoReturn, SupportsIndex, SupportsInt, Tuple, TypeVar, overload
...
@overload
def polyder(
    p: _ArrayLikeFloat_co, m: SupportsInt | SupportsIndex = ...
) -> NDArray[floating[Any]]: ...
@overload
def polyder(
    p: _ArrayLikeComplex_co, m: SupportsInt | SupportsIndex = ...
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
def polyder(
    p: _ArrayLikeObject_co, m: SupportsInt | SupportsIndex = ...
) -> NDArray[object_]: ...
@overload
def polyfit(
...
@overload
def polyval(
    p: _ArrayLikeUInt_co, x: _ArrayLikeUInt_co
) -> NDArray[unsignedinteger[Any]]: ...
@overload
def polyval(
    p: _ArrayLikeInt_co, x: _ArrayLikeInt_co
) -> NDArray[signedinteger[Any]]: ...
@overload
def polyval(p: _ArrayLikeFloat_co, x: _ArrayLikeFloat_co) -> NDArray[floating[Any]]: ...
@overload
def polyval(
    p: _ArrayLikeComplex_co, x: _ArrayLikeComplex_co
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
...
@overload
def polyadd(
    a1: _ArrayLikeUInt_co, a2: _ArrayLikeUInt_co
) -> NDArray[unsignedinteger[Any]]: ...
@overload
def polyadd(
    a1: _ArrayLikeInt_co, a2: _ArrayLikeInt_co
) -> NDArray[signedinteger[Any]]: ...
@overload
def polyadd(
    a1: _ArrayLikeFloat_co, a2: _ArrayLikeFloat_co
) -> NDArray[floating[Any]]: ...
@overload
def polyadd(
    a1: _ArrayLikeComplex_co, a2: _ArrayLikeComplex_co
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
...
@overload
def polydiv(
    u: poly1d, v: _ArrayLikeComplex_co | _ArrayLikeObject_co
) -> _2Tup[poly1d]: ...
@overload
def polydiv(
    u: _ArrayLikeComplex_co | _ArrayLikeObject_co, v: poly1d
) -> _2Tup[poly1d]: ...
@overload
def polydiv(
    u: _ArrayLikeFloat_co, v: _ArrayLikeFloat_co
) -> _2Tup[NDArray[floating[Any]]]: ...
@overload
def polydiv(
    u: _ArrayLikeComplex_co, v: _ArrayLikeComplex_co
