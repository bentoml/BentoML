...
fraud_model_small_runner = bentoml.xgboost.get("ieee-fraud-detection-sm:latest").to_runner()
fraud_model_large_runner = bentoml.xgboost.get("ieee-fraud-detection-lg:latest").to_runner()

svc = bentoml.Service("fraud_detection_inference_graph", runners=[
