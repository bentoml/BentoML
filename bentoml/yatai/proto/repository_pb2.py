...
_LISTBENTOREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels_selector', full_name='bentoml.ListBentoRequest.labels_selector', index=5,
...
_LISTBENTOREQUEST.fields_by_name['labels_selector'].message_type = labels__selector__pb2._LABELSSELECTOR
