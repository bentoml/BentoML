...
import bentoml.yatai.proto.labels_selector_pb2 as labels__selector__pb2
...
_LISTDEPLOYMENTSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels_selector', full_name='bentoml.ListDeploymentsRequest.labels_selector', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTDEPLOYMENTSREQUEST.fields_by_name['labels_selector'].message_type = labels__selector__pb2._LABELSSELECTOR
