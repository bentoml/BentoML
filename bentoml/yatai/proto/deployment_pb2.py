...
_DEPLOYMENTSPEC_AWSEC2OPERATORCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='autoscale_min_capacity', full_name='bentoml.DeploymentSpec.AwsEc2OperatorConfig.autoscale_min_capacity', index=3,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='autoscale_max_capacity', full_name='bentoml.DeploymentSpec.AwsEc2OperatorConfig.autoscale_max_capacity', index=5,
