...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> tuple[Unknown | BlenderbotSmallModel, dict[str, Unbound | list[str] | list[Unknown]]] | BlenderbotSmallModel | tuple[Unknown | BlenderbotModel, dict[str, Unbound | list[str] | list[Unknown]]] | BlenderbotModel:
        ...
...
class BlenderbotForConditionalGeneration(BlenderbotPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> tuple[Unknown | BlenderbotSmallForConditionalGeneration, dict[str, Unbound | list[str] | list[Unknown]]] | BlenderbotSmallForConditionalGeneration | tuple[Unknown | BlenderbotForConditionalGeneration, dict[str, Unbound | list[str] | list[Unknown]]] | BlenderbotForConditionalGeneration:
        ...
