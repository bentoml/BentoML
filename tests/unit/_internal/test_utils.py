...
import bentoml._internal.utils as general
...
def test_validate_labels():
    ...
    with pytest.raises(ValueError):
        general.validate_labels(inp)  # type: ignore (testing bad types)
...
def test_validate_metadata():
    ...
    outp = inp.copy()
    general.validate_metadata(outp)
    assert inp == outp
