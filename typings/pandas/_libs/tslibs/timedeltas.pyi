...
def ints_to_pytimedelta(arr: np.ndarray, box: bool = ...) -> np.ndarray: ...
def array_to_timedelta64(
    values: np.ndarray, unit: str | None = ..., errors: str = ...
) -> np.ndarray: ...
...
class Timedelta(timedelta):
    ...
    value: int
    def __new__(cls: Type[_S], value=..., unit=..., **kwargs) -> _S | NaTType: ...
    @property
    def days(self) -> int: ...
    @property
