...
from numpy import _OrderCF, _OrderKACF, generic, ndarray
...
def tensordot(
    a: ArrayLike, b: ArrayLike, axes: Union[int, Tuple[_ShapeLike, _ShapeLike]] = ...
) -> ndarray: ...
def roll(
    a: ArrayLike, shift: _ShapeLike, axis: Optional[_ShapeLike] = ...
) -> ndarray: ...
def rollaxis(a: ndarray, axis: int, start: int = ...) -> ndarray: ...
def moveaxis(a: ndarray, source: _ShapeLike, destination: _ShapeLike) -> ndarray: ...
def cross(
    a: ArrayLike,
    b: ArrayLike,
    axisa: int = ...,
