...
@attr.define
class BentoConfigTrafficSchema:
    timeout: t.Optional[int] = attr.field(default=None)
    max_concurrency: t.Optional[int] = attr.field(default=None)
    external_queue: bool = attr.field(default=False)


@attr.define
class BentoConfigResourceSchema:
    cpu: t.Optional[str] = attr.field(default=None)
    memory: t.Optional[str] = attr.field(default=None)
    gpu: t.Optional[float] = attr.field(default=None)
    gpu_type: t.Optional[str] = attr.field(default=None)


@attr.define
class BentoConfigWorkerSchema:
    gpu: t.Any = attr.field(default=None)


@attr.define
class BentoConfigServiceSchema:
    traffic: t.Optional[BentoConfigTrafficSchema] = attr.field(default=None)
    resources: t.Optional[BentoConfigResourceSchema] = attr.field(default=None)
    workers: t.Optional[t.List[t.Optional[BentoConfigWorkerSchema]]] = attr.field(
        default=None
    )
