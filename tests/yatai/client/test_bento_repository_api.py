...
def test_save_load(example_bento_service_class):
    with local_yatai_service_container() as yatai_url:
        print(yatai_url)
        ...
        saved_path = svc.save(yatai_url=yatai_url)
        assert saved_path

        bento_pb = yc.repository.get(f'{svc.name}:{svc.version}')
        with TempDirectory() as temp_dir:
            yc.repository.download_to_directory(bento_pb, temp_dir)
            bento_service = load_from_dir(temp_dir)
            assert bento_service.predict(1) == 2


# def test_push(example_bento_service_class):
#     example_bento_service_class = bentoml.ver(major=2, minor=2)(
#         example_bento_service_class
#     )
#
#     yc = get_yatai_client(local_yatai_service_container)
#     test_model = TestModel()
#     svc = example_bento_service_class()
#     svc.pack('model', test_model)
#     saved_path = svc.save()
...
#
#
# def test_pull(latest_released_yatai_server_container, example_bento_service_class):
#     example_bento_service_class = bentoml.ver(major=2, minor=3)(
#         example_bento_service_class
#     )
#
#     yc = get_yatai_client(latest_released_yatai_server_container)
#     test_model = TestModel()
#     svc = example_bento_service_class()
#     svc.pack('model', test_model)
#     saved_path = svc.save(yatai_url=latest_released_yatai_server_container)
#
#     pulled_local_path = yc.repository.pull(f'{svc.name}:{svc.version}')
#     assert pulled_local_path != saved_path
#
#
# def test_push_with_labels(local_yatai_service_container, example_bento_service_class):
#     example_bento_service_class = bentoml.ver(major=2, minor=2)(
#         example_bento_service_class
#     )
#
...
#
#
# def test_pull_with_labels(local_yatai_service_container, example_bento_service_class):
#     example_bento_service_class = bentoml.ver(major=2, minor=3)(
#         example_bento_service_class
#     )
#
...
#     svc.pack('model', test_model)
#     saved_path = svc.save(
#         yatai_url=local_yatai_service_container, labels={'foo': 'bar', 'abc': '123'}
#     )
#
#     pulled_local_path = yc.repository.pull(f'{svc.name}:{svc.version}')
#     assert pulled_local_path != saved_path
...
#
#
# def test_get(local_yatai_service_container, example_bento_service_class):
...
#     svc = example_bento_service_class()
#     svc.pack('model', test_model)
#     svc.save(yatai_url=local_yatai_service_container)
...
#
#
# def test_list(latest_released_yatai_server_container, example_bento_service_class):
...
#     svc = example_bento_service_class()
#     svc.pack('model', test_model)
#     svc.save(yatai_url=latest_released_yatai_server_container)
#
#     bentos = yc.repository.list(bento_name=svc.name)
#     assert len(bentos) == 7
#
#
# def test_load(local_yatai_service_container, example_bento_service_class):
#     example_bento_service_class = bentoml.ver(major=2, minor=5)(
#         example_bento_service_class
#     )
#     yc = get_yatai_client(local_yatai_service_container)
