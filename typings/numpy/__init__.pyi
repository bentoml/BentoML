...
class _ArrayOrScalarCommon:
    ...
    def __setstate__(
        self,
        state: Tuple[SupportsIndex, _ShapeLike, _DType_co, bool, bytes | List[Any]],
        /,
    ) -> None: ...
    @overload
    def all(
...
_ComplexValue = Union[
    None, _CharLike_co, SupportsFloat, SupportsComplex, SupportsIndex, complex
]
...
class busdaycalendar:
    def __new__(
        cls, weekmask: ArrayLike = ..., holidays: ArrayLike = ...
    ) -> busdaycalendar: ...
    @property
