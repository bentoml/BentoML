...
python -m pip install tensorflow==1.15 h5py==2.10.0
pytest -s "$GIT_ROOT"/tests/integration/frameworks/test_keras_model_artifact.py --cov=bentoml --cov-config=.coveragerc
