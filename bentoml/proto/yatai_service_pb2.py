...
_YATAI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='bentoml.Yatai.UpdateUploadStatus',
    index=8,
    containing_service=None,
    input_type=repository__pb2._UPDATEUPLOADSTATUSREQUEST,
    output_type=repository__pb2._UPDATEUPLOADSTATUSRESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='GetBento',
