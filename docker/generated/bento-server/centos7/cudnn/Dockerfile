...
COPY generated/bento-server/centos7/cudnn/cuda.repo /etc/yum.repos.d/cuda.repo
COPY generated/bento-server/centos7/cudnn/nvidia-ml.repo /etc/yum.repos.d/nvidia-ml.repo
