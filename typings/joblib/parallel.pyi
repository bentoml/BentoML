...
class parallel_backend:
    ...
    def __enter__(self): # -> tuple[MultiprocessingBackend | ThreadingBackend | SequentialBackend | LokyBackend | Unknown, Unknown]:
        ...
...
class Parallel(Logger):
    ...
    def __init__(self, n_jobs: Optional[int]=..., backend: Union[str, ParallelBackendBase]=..., verbose: Optional[int]=..., timeout: Optional[float]=..., pre_dispatch: Union[Literal['all'], int, Expr]=..., batch_size: Union[int, Literal['auto']]=..., temp_folder: Optional[str]=..., max_nbytes: Optional[Union[str, int]]=..., mmap_mode: Optional[Literal['r+', 'r', 'w+', 'c']]=..., prefer: Optional[Literal['processes', 'threads']]=..., require: Optional[Literal['sharedmem']]=...) -> None:
        ...
