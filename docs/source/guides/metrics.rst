...
BentoML allows users to define custom metrics with Prometheus [#prometheus]_ to easily enable monitoring for their Bentos.
...
.. [#prometheus] Prometheus website :`[link] <https://prometheus.io/>`_
