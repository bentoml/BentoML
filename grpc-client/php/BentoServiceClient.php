...
use Bentoml\Grpc\V1alpha2\BentoServiceClient;
use Bentoml\Grpc\V1alpha2\NDArray;
use Bentoml\Grpc\V1alpha2\Request;
...
function call()
{
    ...
    $payload->setDtype(\Bentoml\Grpc\V1alpha2\NDArray\DType::DTYPE_FLOAT);
