...
_DEPLOYMENTSPEC = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _DEPLOYMENTSPEC_CUSTOMOPERATORCONFIG,
        _DEPLOYMENTSPEC_SAGEMAKEROPERATORCONFIG,
        _DEPLOYMENTSPEC_AWSLAMBDAOPERATORCONFIG,
        _DEPLOYMENTSPEC_AZUREFUNCTIONSOPERATORCONFIG,
        _DEPLOYMENTSPEC_AWSEC2OPERATORCONFIG,
    ],
