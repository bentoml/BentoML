...
from bentoml._internal.external_typing.starlette import AsgiMiddleware
...
if t.TYPE_CHECKING:
    ...
    MountAppList = t.List[t.Tuple[t.Any, str, str]]
    MiddlewareList = t.List[t.Tuple[t.Type[t.Any], t.Dict[str, t.Any]]]
