...
from typing import Any, Callable, ClassVar, Iterable, Mapping, NoReturn, Tuple, Type
...
class BaseRepresenter:
    ...
    def represent_mapping(self, tag: str, mapping: SupportsItems[Any, Any] | Iterable[Tuple[Any, Any]], flow_style: bool | None = ...) -> MappingNode:
        ...
