...
.. image:: ../../_static/img/bentocloud/autoscaling/gateway-apis.png
   :alt: BentoCloud Gateway APIs
...
To create a Gateway, configure the following fields either on the **Create Gateway** page in the BentoCloud
...
* **Load balancing strategy**
  ...
  * **Overflow Routing**: Routes requests to the highest-ranked Deployment first. Once it reaches capacity, overflow traffic proceeds to the next Deployment. You can customize the time to wait before scaling out to the next Deployment.
...
.. image:: ../../_static/img/bentocloud/autoscaling/bentocloud-gateways.png
   :alt: BentoCloud Gateways
