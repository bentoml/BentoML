...
_STATUS_CODE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='DO_NOT_USE_RESERVED_FOR_FUTURE_EXPANSION_USE_DEFAULT_IN_SWITCH_INSTEAD_',
            index=17,
            number=20,
            serialized_options=None,
            type=None,
...
_STATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='status_code',
            full_name='bentoml.Status.status_code',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='error_message',
            full_name='bentoml.Status.error_message',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
